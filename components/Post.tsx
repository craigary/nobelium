...
type PostProps = {
  post: PostToShow;             // Post metadata
  blockMap: ExtendedRecordMap;  // Post block data
  emailHash: string;            // Author email hash (for Gravatar)
  fullWidth?: boolean;          // Whether in full-width mode
}
