      ...
      <ul className="flex max-w-full overflow-x-auto">
        {Object.keys(tags).map(key => (
          <li
            ...
            className={`mr-3 py-2 my-3 font-medium cursor-pointer  border px-4 whitespace-nowrap bg-gray-100 border-gray-100 text-gray-400 dark:bg-night dark:border-gray-800 dark:text-gray-300 ${
