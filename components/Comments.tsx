...
import type { UtterancesProps } from '@/components/Utterances'

const GitalkComponent = dynamic<{ options: unknown }>(
  () => {
    // @ts-ignore
...
const Comments: React.FC<{ frontMatter: PostToShow; }> = ({ frontMatter }) => {
